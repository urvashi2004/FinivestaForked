...
import FinanceBingo from "./Resources/Games/FinanceBingo/FinanceBingo.js"; // Import Finance Bingo component
    ...
    <div className={`App app-content ${loaded ? 'loaded' : ''}`}>
      ...
      <Layout>
        <Routes>
          ...
          <Route path="/resources/games/FinanceBingo" element={<FinanceBingo />} /> {/* Add Finance Bingo route */}
