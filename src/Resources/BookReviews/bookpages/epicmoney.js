        ...
        <div>
            <div className="book-page-box">
                <div class="book-header ">
                   ...
                   <img src={EpicMoney} alt="MakeEpicMoney"/>
                   </div>
                   
                   <div class="book-title">
                 <h1>Make Epic Money</h1> 
       <p class="author"> by Ankur Warikoo</p>
         
       <p>  Book review by <i> Prabhjot Kaur and Harshita Soni</i></p>
            ...
            <div className="book-para">
                ...
                like a heart-to-heart conversation with an elder brother than a lecture. The book covers not just investment strategies but also saving habits, 
                how to allocate your income proportionately, and crucial aspects of life like health and life insurance—topics rarely explained with such clarity and depth. <br />
                ...
                <h2>Highlights</h2>
                    ...
                    <ul>
                        ...
                        <li>It covers all major concepts regarding money like our mindset, compounding, insurances, SIPs,etc. </li>
                        <li>Makes one learn things on the basis of the author's past experiences and real life examples like sunk lost fallacy, framing effect, mental accounting,etc. </li>
                    </ul>
                    <br/>
                    
                    <h4>Our favourite quotes from the book were : </h4>
                    
                    <ul>
                        <li>‘Money has a little to do with how smart you are and a lot to do with how you behave and behaviour is hard to teach, even to really smart people.’ —Morgan Housel</li>
                        <li>‘If you don’t design your own life plan, chances are that you’ll fall into someone else’s and guess what they have planned for you? Not much.’ —Jim Rohn</li>
                    </ul>
                    <br/>
                    </p>
